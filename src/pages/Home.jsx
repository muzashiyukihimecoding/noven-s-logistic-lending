...
const SistemPeminjamanLogistikKampus = () => {
   ...
   const organizations = [
      {
         ...
         rating: 4.9,
         description:
            "Badan Eksekutif Mahasiswa tingkat Universitas yang menaungi seluruh kegiatan kemahasiswaan.",
      ...
      },
      {
         ...
         rating: 4.7,
         description:
            "Unit Kegiatan Mahasiswa yang berfokus pada pelestarian dan pengembangan seni budaya tradisional maupun modern.",
      ...
      },
      {
         ...
         rating: 4.8,
         description:
            "Himpunan mahasiswa fakultas teknik yang aktif dalam pengembangan riset dan teknologi tepat guna.",
      ...
      },
      {
         ...
         rating: 4.6,
         description:
            "Wadah bagi mahasiswa untuk mengembangkan minat dan bakat di bidang olahraga prestasi.",
   ...
   const items = [
      {
         ...
         available: 5,
         description:
            "Proyektor resolusi tinggi 1080p dengan brightness 3000 lumens. Cocok untuk presentasi kelas, rapat, atau acara seminar. Dilengkapi dengan kabel HDMI dan remote control.",
         reviews: 45,
         requirements: [
      ...
      },
      {
         ...
         available: 7,
         description:
            "Speaker portable dengan output 500W, dilengkapi dengan 2 microphone wireless. Cocok untuk acara indoor dan outdoor dengan jangkauan suara yang jelas.",
         reviews: 32,
         requirements: [
      ...
      },
      {
         ...
         available: 5,
         description:
            "Tenda regu kapasitas 8-10 orang. Bahan waterproof dan frame alumunium yang kokoh.",
         reviews: 12,
         requirements: [
      ...
      },
      {
         ...
         available: 18,
         description:
            "Satu set kostum tari tradisional lengkap dengan aksesoris kepala dan selendang.",
         reviews: 25,
         requirements: [
   ...
   const bundles = [
      {
         ...
         status: "Tersedia",
         description:
            "Paket lengkap untuk acara seminar dan workshop. Semua peralatan sudah terintegrasi dan siap pakai. Hemat 20% dibanding sewa terpisah.",
         reviews: 15,
         requirements: [
   ...
   const handleRentRequest = (item) => {
      const newTrx = {
         ...
         endDate: new Date(Date.now() + item.maxDuration * 24 * 60 * 60 * 1000)
            .toISOString()
            .split("T")[0],
               ...
               <div className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600">
                  <button
                     ...
                     className={`flex items-center gap-2 hover:text-blue-600 transition-colors ${
                        activePage === "home" ? "text-blue-600 font-bold" : ""
                     }`}
                  >
                     <Home size={16} />
                     Beranda
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
               <div className="md:w-1/2 space-y-8">
                  ...
                  <p className="text-blue-100 text-lg md:w-4/5 leading-relaxed">
                     Sistem peminjaman terintegrasi untuk UKM, himpunan, dan
                     organisasi kampus. Dengan fitur Double Handshake Protocol
                  ...
                  <div className="grid grid-cols-2 gap-4 max-w-md">
                     <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 shadow-2xl transform rotate-3 hover:rotate-0 transition-all duration-500">
                        ...
                        <p className="text-blue-100 text-sm">
                           Hemat hingga 30% dengan paket event lengkap
                        </p>
                     </div>
                     <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 shadow-2xl transform -rotate-2 hover:rotate-0 transition-all duration-500 mt-8">
                        ...
                        <p className="text-blue-100 text-sm">
                           Pengingat pengembalian otomatis
                        </p>
                     </div>
   ...
   const ItemCard = ({ item }) => (
      <div
         onClick={() =>
            item.isBundle ? setSelectedBundle(item) : setSelectedItem(item)
         }
                  ...
                  <div>
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500">
                           ...
                           <span className="flex items-center gap-1">
                              ⭐ {selectedBundle.rating} (
                              {selectedBundle.reviews} Review)
                           </span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-green-200 shadow-sm">
                     <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-lg font-bold text-green-600">
                           Rp{selectedBundle.savings.toLocaleString()}
                        </span>
                     </div>
                     <div className="flex justify-between items-center text-sm">
                        <span className="text-gray-500">Harga Normal:</span>
                        <span className="text-gray-400 line-through">
                           Rp{selectedBundle.originalPrice.toLocaleString()}
                        </span>
                     </div>
                  </div>
               </div>
               ...
               <div className="md:w-3/5 p-8 overflow-y-auto">
                  <div className="space-y-6">
                        ...
                        <div className="flex justify-between items-center mb-4">
                           <div>
                              ...
                              <div className="text-3xl font-bold text-blue-600">
                                 Rp{selectedBundle.price.toLocaleString()}
                              </div>
                           </div>
                           <div className="text-right">
                              ...
                              <div className="font-bold text-gray-700">
                                 {selectedBundle.maxDuration} Hari
                              </div>
                           </div>
                        </div>
                        <button
                     ...
                     <div>
                        ...
                        <div className="space-y-3">
                           {selectedBundle.bundleItems.map(
                              (bundleItem, idx) => (
                                 <div
                                    key={idx}
                        ...
                        <div>
                           ...
                           <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                              <p className="text-sm text-green-800 font-medium">
                                 {selectedBundle.guarantee}
                              </p>
                              <p className="text-xs text-green-600 mt-2">
                                 Jaminan akan dikembalikan setelah barang
                                 diverifikasi
                              </p>
                           </div>
                        </div>
                  ...
                  <div>
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500">
                           ...
                           <span className="flex items-center gap-1">
                              ⭐ {selectedItem.rating} ({selectedItem.reviews}{" "}
                              Review)
                           </span>
                        </div>
                     </div>
            ...
            <div className="flex gap-3">
               ...
               <div>
                  ...
                  <p className="text-xs text-gray-600 mb-2">
                     Sewa{" "}
                     <span className="font-bold">
                        Sound System Portable 500W
                     </span>{" "}
                     berakhir dalam{" "}
                     <span className="text-red-600 font-bold">2 hari</span>.
                  </p>
                  <button
                     onClick={() => {
   ...
   const OrganizationPage = () => {
      ...
      if (selectedOrg) {
         const orgItems = items.filter(
            (item) => item.owner === selectedOrg.name
         );
         const orgBundles = bundles.filter(
            (bundle) => bundle.owner === selectedOrg.name
         );
                        ...
                        <div>
                           ...
                           <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-4">
                              <span className="flex items-center gap-1 bg-gray-100 px-3 py-1 rounded-full">
                                 <Users size={14} /> {selectedOrg.members}{" "}
                                 Anggota
                              </span>
                              <span className="flex items-center gap-1 bg-gray-100 px-3 py-1 rounded-full">
                  ...
                  {orgItems.length === 0 && orgBundles.length === 0 ? (
                     <div className="text-center py-12 bg-gray-50 rounded-2xl border border-gray-200 border-dashed">
                        <p className="text-gray-500">
                           Organisasi ini belum memiliki barang yang disewakan.
                        </p>
                     </div>
                  ) : (
         ...
         <div className="pt-32 container mx-auto px-6 pb-20 min-h-screen">
            ...
            <div className="text-center mb-16">
               ...
               <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Temukan profil lengkap, kontak, dan inventaris logistik dari
                  berbagai organisasi mahasiswa di kampus.
               </p>
            </div>
            ...
            <>
               ...
               <main className="container mx-auto px-6 pb-20">
                  ...
                  <div className="text-center mb-12">
                     ...
                     <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Temukan berbagai kebutuhan logistik untuk acara UKM,
                        himpunan, dan organisasi kampus lainnya
                     </p>
                  </div>
               ...
               {transactions.length === 0 && (
                  <div className="text-center py-20">
                     ...
                     <p className="text-gray-500 mb-6">
                        Mulai pinjam barang untuk melihat aktivitas di sini
                     </p>
                     <button
                        onClick={() => setActivePage("home")}
         ...
         <footer className="bg-white border-t border-gray-200 py-16 mt-20">
            <div className="container mx-auto px-6">
               <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  <div>
                     ...
                     <p className="text-sm text-gray-500 leading-relaxed">
                        Sistem peminjaman logistik terintegrasi untuk lingkungan
                        kampus. Mendukung UKM, himpunan, dan organisasi lainnya
               ...
               <div className="border-t border-gray-100 mt-12 pt-8 text-center text-sm text-gray-400">
                  © 2025 Sistem Peminjaman Logistik Kampus. All rights reserved.
               </div>
            </div>
         </footer>
      </div>
